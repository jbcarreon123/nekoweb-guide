...
## Disclaimer
We will try to deploy the site you created on the [Eleventy guide](/eleventy) as an example, but you can do this on all other SSGs/frameworks with zero to some slight modification to the guide.
...
## Overview
If you're editing your site locally for a while, you might wanna know how to upload your site directly after you built it, because you have switched to an SSG for example but is still uploading your site manually to Nekoweb dashboard. This guide will outline automating your deployment workflow so you can either run a command or push it to your GitHub repository and it will deploy your site to Nekoweb, automatically.
...
## Prerequisites
This are the things you need on all of them:
- A Nekoweb account
